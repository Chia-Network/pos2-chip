...
struct PlotBackPointers {
    uint32_t l;
    uint32_t r;

   bool operator==(PlotBackPointers const &o) const = default;
};
...
struct PlotData {
    ...
    std::vector<std::vector<PlotBackPointers>> t4_to_t3_back_pointers;
    std::vector<std::vector<PlotBackPointers>> t5_to_t4_back_pointers;
